...
export function LampDemo({ date, time }) {
  return (
    <LampContainer>
      <motion.h1
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[calc(100vh-5rem)] flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0 mx-auto",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        <motion.div
          ...
          className="absolute inset-auto right-[40%] h-48 overflow-visible w-[30rem] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-[30%] h-48 w-[30rem] bg-gradient-conic from-transparent via-transparent to-cyan-500 text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <div className="absolute top-1/2 h-36 w-full translate-y-10 scale-x-150 bg-slate-950 blur-2xl"></div>
